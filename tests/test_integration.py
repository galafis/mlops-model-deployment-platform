...
class TestMLOpsIntegration(unittest.TestCase):
    ...
    def test_full_deployment_lifecycle_via_api(self):
        ...
        response = self.client.post(
            f"/predict/{self.model_v1.metadata.name}/{self.model_v1.metadata.version}", json=predict_payload
        )
        ...
        undeploy_payload = {"model_name": self.model_v1.metadata.name, "model_version": self.model_v1.metadata.version}
